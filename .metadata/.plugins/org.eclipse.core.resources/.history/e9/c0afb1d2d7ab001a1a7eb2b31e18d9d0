...
//			System.out.println(department.getEmps());
	...
	public void test07() throws IOException {
		...
		try{			
			...
			//测试if/where
//			List<Employee> empsByConditionIf = mapper.getEmpsByConditionIf(new Employee(null,"Jack",null,null));
//			System.out.println(empsByConditionIf);
			
			//查询的时候如果某些条件没带可能会造成sql语句拼装出现问题
			//1.在where后面拼接1=1，之后的条件都and xxx
			//2.mybatis使用where标签将所有的查询条件包括在内，mybatis会将where标签内sql语句多余的and或者or去掉，但只会去掉第一个多余的and或者or
			
			//测试trim
//			List<Employee> empsByConditionTrim = mapper.getEmpsByConditionTrim(new Employee(null,"Jack",null,null));
//			System.out.println(empsByConditionTrim);
			
			//测试choose
//			List<Employee> empsByConditionChoose = mapper.getEmpsByConditionChoose(new Employee(1,"Jack",null,null));
//			System.out.println(empsByConditionChoose);
			
			//测试set
//			mapper.updateEmp(new Employee(3,"Jerry",null,"Jerry@qq.com"));
	...
	public void test08() throws IOException {
		...
		try{			
			...
			emps.add(new Employee(null,"Smith","0","Smith@qq.com",new Department(1)));
			emps.add(new Employee(null,"Bob","1","Bob@qq.com",new Department(2)));
			mapper.addEmps(emps);
